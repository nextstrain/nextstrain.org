...
The WHO currently estimates the overall case-fatality rate at 3.4%, but says that it can range from 0.7% to 4% depending on the quality of the healthcare system where the case is treated. Based on data from China, the case-fatality rate was 14.8% in patients aged ≥80 year, 8.0% in patients aged 70-79 years, and 49.0% in critical cases. The WHO-China CDC Joint Report found that while women and men were infected at similar rates, COVID-19 infections seem to be more severe in men as only 2.8% of Chinese women who were infected died from the disease, while 4.7% of infected men died.
