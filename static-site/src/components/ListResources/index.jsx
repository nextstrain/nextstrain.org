...
function SortOptions({sortMethod, changeSortMethod}) {
  ...
  return (
    <SortContainer>
      Sort pathogens by: 
      <input type="radio" onChange={onChangeValue} value="alphabetical" checked={"alphabetical"===sortMethod} />
      <TooltipWrapper description={'Pathogen groups ordered alphabetically. ' +
        '<br/>' +
        'Datasets within each group ordered alphabetically.'}>
        alphabetical
      </TooltipWrapper>
      <input type="radio" onChange={onChangeValue} value="lastUpdated" checked={"lastUpdated"===sortMethod} />
