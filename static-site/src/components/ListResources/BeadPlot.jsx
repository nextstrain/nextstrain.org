 ...
 * no onClick
 * 
 * So we should actually calculate (ourselves) the width of each tile, and then use
 * this in the SVG.
 * Heaps of datasets will have identical version arrays, so can we cache this?
 */
export const BeadPlotRaw = ({versions, onClick, xPx}) => {
  if (!versions.length) return null;
  
  const viewBox = [0,0,100,10]
