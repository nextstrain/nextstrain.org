...
export function SmallSpacer({ count }: { count?: number }): ReactElement {
  return <Spacer count={count} height={DEFAULT_HEIGHTS["small"]} />;
}

export function MediumSpacer({ count }: { count?: number }): ReactElement {
  return <Spacer count={count} height={DEFAULT_HEIGHTS["medium"]} />;
}

export function BigSpacer({ count }: { count?: number }): ReactElement {
  return <Spacer count={count} height={DEFAULT_HEIGHTS["big"]} />;
}
export function HugeSpacer({ count }: { count?: number }): ReactElement {
