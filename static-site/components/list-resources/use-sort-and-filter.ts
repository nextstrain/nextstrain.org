...
// helper function to sort alphabetically. If provided with YYYY-MM-DD
// strings this is the same as a chronological sort (oldest to newest)
function _lexicographicSort(a: string, b: string): 1 | -1 | 0 {
  return a < b ? -1 : a > b ? 1 : 0;
}

// If provided with YYYY-MM-DD strings this sorts chronologically with
// newest first (this is just reverse lexicographic sort)
