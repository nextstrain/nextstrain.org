...
export const generateLogos = [
  <a key={1} href="http://www.fredhutch.org/" target="_blank">
    <img width="75" src={require("../../../static/logos/fred-hutch-logo.png")} />
  </a>,
  <a key={2} href="http://www.eb.tuebingen.mpg.de/" target="_blank">
    <img width="65" src={require("../../../static/logos/max-planck-logo.png")} />
  </a>,
  <a key={3} href="https://www.nih.gov/" target="_blank">
    <img width="52" src={require("../../../static/logos/nih-logo.jpg")} />
  </a>,
  <a key={4} href="https://erc.europa.eu/" target="_blank">
    <img width="60" src={require("../../../static/logos/erc-logo.jpg")} />
  </a>,
