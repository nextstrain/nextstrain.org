...
export default function Page() {
  ...
  return (
    <div>
      <h1>Child 1</h1>
      {`This is from ./app/parent/child1/page.jsx and is a server component (`}
      ...
      <p/>
      <p/>
      <Link href="/parent/child2">Next.js Link component to sibling page</Link>
      <br/>
      <a href="/parent/child2">HTML anchor to sibling page</a>
    </div>
  );
}
