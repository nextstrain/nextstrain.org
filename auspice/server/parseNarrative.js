/* This file is taken from auspice -- https://github.com/nextstrain/auspice/blob/extend/cli/server/parseNarrative.js
 * Once auspice is adapted to expose helper functions, i.e. const auspice = require("auspice");
