...
function _isIntermediateFile(key) {
  const excludePatterns = [
    /\/(?:branch|test|test-data|trial|trials)\//, // testing/tmp directories
    /\/forecasts-(flu|ncov)\//,
    /\/cartography\//,
    /\/monkeypox\//, // Data from 2022-06-01 - 2023-10-31. Could combine this with the mpox files if desired. 
    /\/tb\//, // the TB workflow is in flux - revisit once the datasets are "released"
